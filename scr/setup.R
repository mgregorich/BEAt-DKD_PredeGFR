...
pacman::p_load(tidyr, plyr, reshape2, ggplot2, openxlsx, stringr, transplantr, skimr,shiny,
               ...
               shinyvalidate, shinyalert, RColorBrewer)
...
# Set of predictors
pred.vars <- c("BL_age","BL_sex", "BL_smoking","BL_bmi", "BL_map",
               "BL_hba1c", "BL_serumchol", "BL_hemo", "BL_uacr_log2",
               "BL_med_dm", "BL_med_bp", "BL_med_lipid")

# Folders
if(!dir.exists(here::here(out.path, "model_main"))){
  dir.create(here::here(out.path, "model_main"))
  dir.create(here::here(out.path, "model_sa"))
  dir.create(here::here(out.path, "model_clin"))
  dir.create(here::here(out.path, "model_uacr"))
  }
